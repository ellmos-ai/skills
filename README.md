...
The current public catalog contains 43 runtime skills:
...
| `utilities` | 10 | Batch operations, thinking frameworks, document chunking, encoding repair, YouTube transcripts |
