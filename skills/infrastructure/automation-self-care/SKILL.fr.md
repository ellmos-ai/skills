...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `automation-self-care`.
...
## Limites Absolues et Règles Inviolables
