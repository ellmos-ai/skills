...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Documentation complète traduite en français pour la compétence folder-flattening: Restructure nested folder hierarchies into flat, machine-readable layouts. Bash-based with intelligent merge logic.
...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `folder-flattening`.
