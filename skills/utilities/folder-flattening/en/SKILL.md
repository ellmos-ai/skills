...
> **English** — Official English version of `folder-flattening`.
...
| Phase | Description | Script Section |
|-------|-------------|----------------|
...
| 4 | Group: Move numbered folders, CD folders, and short names into collection folders | `phase_group_problematic` |
