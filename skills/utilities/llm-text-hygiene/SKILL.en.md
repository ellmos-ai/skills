...
created: 2026-07-04
updated: 2026-07-04
description: Text-Skill zum Prüfen und Bereinigen von LLM-Spuren in fertigen Texten (Paper, README, Bericht, Blogpost, Bewerbung): Chat-/Prompt-Reste und Regieanweisungen („Wie besprochen lassen wir diesen Teil …"), stehengebliebene Platzhalter, LLM-Danksagungen, typische LLM-Stilmuster und typografische Artefakte — plus Korrektheits-Check der AI-Disclosure. Nutze diesen Skill bei „LLM-Muster/KI-Spuren entfernen", „klingt nach ChatGPT/KI", „Chat-Reste im Text", „Paper vor Publikation auf KI-Rückstände prüfen", „AI-Disclosure prüfen", oder als periodischen Check über einen Dokumentbestand. Immer über ALLE Sprachfassungen eines Dokuments. Für Byte-/Encoding-Reparatur stattdessen encoding-fix.
