...
created: 2026-06-19
updated: 2026-06-19
description: [Français] Documentation complète traduite en français pour la compétence privat-mail-writer: Dieser Skill sollte genutzt werden, wenn der User private oder halbformale E-Mails schreiben, beantworten, absagen, nachfassen, kürzen, umformulieren oder im eigenen Stil entwerfen lassen will, besonders bei Terminen, offiziellen Absagen, freundlichen Kurzantworten und kontaktabhängigem Ton. Profilanalyse erst bei einem konkreten Mail-Schreibauftrag starten.
standalone: true
...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `privat-mail-writer`.
