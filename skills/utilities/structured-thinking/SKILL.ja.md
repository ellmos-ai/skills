...
created: 2026-05-19
updated: 2026-05-19
description: [日本語] エージェントスキル: structured-thinking: Meta-skill: Structured thinking as a 3-phase workflow. Combines analysis (think), ideation (brainstorm), and decision-making (decide) into one continuous process.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `structured-thinking`.
