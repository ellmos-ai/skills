...
created: 2026-03-12
updated: 2026-03-12
description: [Español] Documentación completa para la habilidad encoding-fix: Mojibake repair for double/triple encoded UTF-8. Fixes Windows cp1252/Latin-1 misinterpretations. Zero dependencies.
standalone: true
...
> **Español** — Documentación oficial completa traducida al español para la habilidad `encoding-fix`.
