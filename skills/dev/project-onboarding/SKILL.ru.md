...
created: 2026-03-12
updated: 2026-03-12
description: [Русский] Навык агента для project-onboarding: Standard procedure for onboarding new software projects: Feature analysis, code quality review, onboarding checklist, and task creation.
...
> **Официальная Русская Версия** — Полное руководство и документация на русском языке для навыка `project-onboarding`.
