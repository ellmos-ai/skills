...
created: 2026-02-21
updated: 2026-03-12
description: [Español] Documentación completa para la habilidad plugin-system: Generic plugin system for Python applications. Auto-discovery, validation, fault tolerance. Zero dependencies (Python stdlib only).
standalone: true
...
> **Español** — Documentación oficial completa traducida al español para la habilidad `plugin-system`.
