...
created: 2026-02-21
updated: 2026-03-12
description: [中文] 智能体技能: plugin-system: Generic plugin system for Python applications. Auto-discovery, validation, fault tolerance. Zero dependencies (Python stdlib only).
...
> **官方中文版** — 针对该技能的完整中文文档: `plugin-system`.
