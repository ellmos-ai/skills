...
created: 2026-03-15
updated: 2026-03-15
description: [Español] Documentación completa traducida al español para la habilidad migrate-rename: Evolutionary file renaming with wrapper files. Enables renames without hard breaks — references are organically updated through usage.
...
> **Español** — [Español] Documentación completa traducida al español para la habilidad `migrate-rename`.
