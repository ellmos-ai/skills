...
created: 2026-03-15
updated: 2026-03-15
description: [Français] Documentation complète traduite en français pour la compétence migrate-rename: Evolutionary file renaming with wrapper files. Enables renames without hard breaks — references are organically updated through usage.
...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `migrate-rename`.
