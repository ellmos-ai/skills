...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Documentation complète traduite en français pour la compétence bugfix-protocol: Systematic 6-phase debugging protocol. Structured approach to bugs with quick checks, isolated testing, 20-minute rule, and bug report template.
...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `bugfix-protocol`.
