...
description: Tiefe, nutzerneutrale Nachpflege veröffentlichter Repositories mit Rechts-Wiedervorlage, projektübergreifenden Verweisen und vollständiger Produktlokalisierung.
version: 1.0.0
type: skill
author: Lukas Geiger
created: 2026-03-12
...
bach_origin: false
category: dev
tags: [maintenance, repository, localization, legal-review]
language: de
status: active
dependencies:
  tools: [git, gh, rg]
...
> **English Translation** — Official English version of `full-after-care`.


# Full After Care — die tiefe Runde (Synonym: Deep After Care) (Deutsch)
