...
created: 2026-03-15
updated: 2026-03-15
description: [中文] 智能体技能: docs-analysis: Document requirements analysis: Analyzes concept and requirements documents in the docs/ folder, checks requirements against current code, and creates a consolidated difference report.
...
> **官方中文版** — 针对该技能的完整中文文档: `docs-analysis`.
