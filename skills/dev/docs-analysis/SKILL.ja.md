...
created: 2026-03-15
updated: 2026-03-15
description: [日本語] エージェントスキル: docs-analysis: Document requirements analysis: Analyzes concept and requirements documents in the docs/ folder, checks requirements against current code, and creates a consolidated difference report.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `docs-analysis`.
