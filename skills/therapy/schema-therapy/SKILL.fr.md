...
created: 2026-03-15
updated: 2026-03-15
description: [Français] Compétence d'agent pour schema-therapy: Schema Therapy according to Jeffrey Young: Schemas, modes, inner child concept, and coping styles — psychoeducationally presented.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `schema-therapy`.
