...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: counseling-basics: Fundamentals of therapeutic communication: Active listening, mirroring, paraphrasing, open questions, and validation.
...
> **中文** — [中文] 针对该技能的完整中文文档: `counseling-basics`.
