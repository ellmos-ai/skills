...
created: 2026-03-15
updated: 2026-03-15
description: [日本語] エージェントスキル: guideline-therapies-overview: Comparison of the four guideline-approved psychotherapy approaches in Germany: Cognitive Behavioral Therapy, Psychodynamic Therapy, Psychoanalysis, Systemic Therapy — Orientation guide.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `guideline-therapies-overview`.
