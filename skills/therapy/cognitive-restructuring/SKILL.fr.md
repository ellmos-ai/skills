...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Compétence d'agent pour cognitive-restructuring: Cognitive Behavioral Therapy: ABC model, automatic thoughts, identifying cognitive distortions, and keeping thought records.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `cognitive-restructuring`.
