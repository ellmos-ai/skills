...
created: 2026-03-12
updated: 2026-03-12
description: [日本語] エージェントスキル: cognitive-restructuring: Cognitive Behavioral Therapy: ABC model, automatic thoughts, identifying cognitive distortions, and keeping thought records.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `cognitive-restructuring`.
