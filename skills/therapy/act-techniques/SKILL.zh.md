...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: act-techniques: Acceptance & Commitment Therapy (ACT) according to Steven Hayes: Hexaflex model with the six core processes of psychological flexibility.
...
> **中文** — [中文] 针对该技能的完整中文文档: `act-techniques`.
