...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Compétence d'agent pour act-techniques: Acceptance & Commitment Therapy (ACT) according to Steven Hayes: Hexaflex model with the six core processes of psychological flexibility.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `act-techniques`.
