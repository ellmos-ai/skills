...
created: 2026-03-12
updated: 2026-03-12
description: [Español] Documentación completa traducida al español para la habilidad behavioral-activation: Behavioral activation for depression: Breaking the vicious cycle, activity monitoring, weekly planning, and values-based activities.
...
> **Español** — [Español] Documentación completa traducida al español para la habilidad `behavioral-activation`.
