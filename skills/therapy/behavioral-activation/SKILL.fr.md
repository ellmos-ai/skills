...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Compétence d'agent pour behavioral-activation: Behavioral activation for depression: Breaking the vicious cycle, activity monitoring, weekly planning, and values-based activities.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `behavioral-activation`.
