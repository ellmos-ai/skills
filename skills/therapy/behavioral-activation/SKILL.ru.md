...
created: 2026-03-12
updated: 2026-03-12
description: [Русский] Навык агента для behavioral-activation: Behavioral activation for depression: Breaking the vicious cycle, activity monitoring, weekly planning, and values-based activities.
...
> **Официальная Русская Версия** — Полное руководство и документация на русском языке для навыка `behavioral-activation`.
