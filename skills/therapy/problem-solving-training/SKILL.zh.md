...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: problem-solving-training: Structured problem solving in 6 steps: Problem definition, goals, brainstorming, evaluation, implementation, and review.
...
> **中文** — [中文] 针对该技能的完整中文文档: `problem-solving-training`.
