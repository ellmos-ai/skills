...
created: 2026-03-12
updated: 2026-03-12
description: [Español] Habilidad y protocolo de agente para problem-solving-training: Structured problem solving in 6 steps: Problem definition, goals, brainstorming, evaluation, implementation, and review.
...
> **Traducción al Español** — Versión oficial en español de `problem-solving-training` (Fase 3: Multilingüe).
