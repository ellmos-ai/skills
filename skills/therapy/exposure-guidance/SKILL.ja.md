...
created: 2026-03-12
updated: 2026-03-12
description: [日本語] エージェントスキル: exposure-guidance: Graded exposure for anxiety disorders: Fear hierarchy, SUDs scale, exposure planning and guidance. Psychoeducation only, not implementation.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `exposure-guidance`.
