...
created: 2026-03-15
updated: 2026-03-15
description: [Français] Compétence d'agent pour genogram-work: Genogram work: Recognizing and reflecting on family relationship patterns. Multigenerational perspective, genogram symbols, pattern recognition, and resources in family history.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `genogram-work`.
