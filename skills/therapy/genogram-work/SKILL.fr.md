...
created: 2026-03-15
updated: 2026-03-15
description: [Français] Documentation complète traduite en français pour la compétence genogram-work: Genogram work: Recognizing and reflecting on family relationship patterns. Multigenerational perspective, genogram symbols, pattern recognition, and resources in family history.
...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `genogram-work`.
