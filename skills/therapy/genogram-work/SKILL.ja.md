...
created: 2026-03-15
updated: 2026-03-15
description: [日本語] エージェントスキル: genogram-work: Genogram work: Recognizing and reflecting on family relationship patterns. Multigenerational perspective, genogram symbols, pattern recognition, and resources in family history.
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `genogram-work`.
