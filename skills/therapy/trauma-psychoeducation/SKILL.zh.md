...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: trauma-psychoeducation: Trauma psychoeducation: Trauma definition, normal reactions, window of tolerance, trigger management, and self-care.
...
> **中文** — [中文] 针对该技能的完整中文文档: `trauma-psychoeducation`.
