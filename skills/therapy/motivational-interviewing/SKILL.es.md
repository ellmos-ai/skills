...
created: 2026-03-12
updated: 2026-03-12
description: [Español] Habilidad y protocolo de agente para motivational-interviewing: Motivational Interviewing (MI) according to Miller and Rollnick: OARS techniques, change talk, fostering readiness for change.
...
> **Traducción al Español** — Versión oficial en español de `motivational-interviewing` (Fase 3: Multilingüe).
