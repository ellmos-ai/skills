...
created: 2026-03-12
updated: 2026-03-12
description: [Русский] Навык агента для motivational-interviewing: Motivational Interviewing (MI) according to Miller and Rollnick: OARS techniques, change talk, fostering readiness for change.
...
> **Официальная Русская Версия** — Полное руководство и документация на русском языке для навыка `motivational-interviewing`.
