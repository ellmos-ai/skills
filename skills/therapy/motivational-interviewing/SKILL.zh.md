...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: motivational-interviewing: Motivational Interviewing (MI) according to Miller and Rollnick: OARS techniques, change talk, fostering readiness for change.
...
> **中文** — [中文] 针对该技能的完整中文文档: `motivational-interviewing`.
