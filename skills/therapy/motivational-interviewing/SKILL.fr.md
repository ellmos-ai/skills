...
created: 2026-03-12
updated: 2026-03-12
description: [Français] Compétence d'agent pour motivational-interviewing: Motivational Interviewing (MI) according to Miller and Rollnick: OARS techniques, change talk, fostering readiness for change.
...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `motivational-interviewing`.
