...
created: 2026-03-12
updated: 2026-03-12
description: [中文] 针对该技能的完整中文文档: pmr-autogenic-training: Progressive Muscle Relaxation (PMR) according to Jacobson and Autogenic Training according to Schultz. Short forms and full versions.
...
> **中文** — [中文] 针对该技能的完整中文文档: `pmr-autogenic-training`.
