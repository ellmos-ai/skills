...
> **Versión Oficial en Español** — Documentación completa traducida al español para la habilidad `rojo`.



# Rojo — Filesystem → Roblox Studio Sync (Versión en Español)
