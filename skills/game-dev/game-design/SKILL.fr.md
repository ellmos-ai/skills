...
> **Version Officielle en Français** — Documentation complète traduite en français pour la compétence `game-design`.
...
## Flux de Travails (development chains)
