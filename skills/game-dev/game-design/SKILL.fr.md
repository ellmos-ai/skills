...
> **Français** — [Français] Documentation complète traduite en français pour la compétence `game-design`.
...
## Flux de Travail et Étapess (development chains)
