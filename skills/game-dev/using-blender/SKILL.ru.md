...
> **Русский** — [Русский] Полное руководство и документация на русском языке для навыка `using-blender`.
