...
updated: 2026-07-30
description: >
  Analyzes supplied inventory lists or exports without depending on a specific inventory app.
standalone: true
...
Evaluate stock, locations, minimum quantities, and inconsistencies.

**Result:** Inventory overview, shortages, duplicates, and clarification needs.
...
**Input:** Analyze this CSV list for shortages and duplicate entries.
