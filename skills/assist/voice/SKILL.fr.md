...
updated: 2026-07-30
description: >
  Planifie enregistrement, transcription et synthèse vocale avec des outils optionnels interchangeables.
standalone: true
...
# Assistant vocal neutre

## Objectif

Définir un flux vocal sans imposer un fournisseur privé.

**Résultat:** Plan avec format d'entrée, décision de confidentialité, options et solution de repli.
...
**Entrée:** Planifie un flux local de transcription pour un fichier audio.
...
- Le consentement, la classification et la conservation doivent être clarifiés avant tout traitement cloud.
