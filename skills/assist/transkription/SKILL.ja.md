...
created: 2026-06-22
updated: 2026-06-22
description: [日本語] エージェントスキル: transkription: Transcribes audio/video files to text. Uses Whisper (openai-whisper) or Vosk (offline) as optional backend — both are detected via presence check. Without backend: placeholder mode with dummy output (dry-run).
...
> **公式日本語版** — スキルに関する完全な日本語ドキュメント: `transkription`.
